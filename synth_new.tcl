...
# set search_path ". /Software/synopsys/2017/syn_vM-2016.12-SP4/minpower/syn /Software/synopsys/2017/syn_vM-2016.12-SP4/dw/syn_ver /Software/synopsys/2017/syn_vM-2016.12-SP4/dw/sin_ver /Software/cadence/vendors/VTVT/vtvt_tsmc180/Synopsys_Libraries/libs . /home/choudhary/pulpino/rtl  /home/choudhary/pulpino/rtl/components  /home/choudhary/pulpino/rtl/includes  /home/choudhary/pulpino/sw/build/apps/sequential_tests/motion_detection/WORK"
...
set my_verilog_files [list  noc.sv  input_block2crossbar.sv  input_block2switch_allocator.sv  input_block2vc_allocator.sv  router2router.sv  switch_allocator2crossbar.sv  router.sv  router_link.sv  node_link.sv  mesh.sv  rc_unit.sv  input_port.sv  input_buffer.sv  input_block.sv  circular_buffer.sv  separable_input_first_allocator.sv  round_robin_arbiter.sv]

# Set the top module of your design
set my_toplevel mesh

# This command does the same work of analyze+elaborate
# read_verilog $my_verilog_files   

# Translates HDL to intermediate format
analyze -format sverilog [list  noc.sv  input_block2crossbar.sv  input_block2switch_allocator.sv  input_block2vc_allocator.sv  router2router.sv  switch_allocator2crossbar.sv  router.sv  router_link.sv  node_link.sv  mesh.sv  rc_unit.sv  input_port.sv  input_buffer.sv  input_block.sv  circular_buffer.sv  separable_input_first_allocator.sv  round_robin_arbiter.sv]
